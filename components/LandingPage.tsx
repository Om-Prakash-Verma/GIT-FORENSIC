...
const LandingPage: React.FC<LandingPageProps> = ({ repoPath, setRepoPath, onConnect, isLoading }) => {
  return (
    <div className="min-h-screen w-screen bg-[#020617] flex flex-col items-center justify-center p-4 md:p-8 selection:bg-amber-500/20 relative overflow-hidden">
      ...
      <div className="w-full max-w-xl space-y-8 md:space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 relative z-10">
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <p className="text-slate-500 text-[10px] md:text-xs font-black tracking-[0.4em] uppercase">Enterprise Root-Cause HUD</p>
              <div className="h-px w-8 bg-amber-500/30" />
            </div>
          </div>
        </div>
        ...
        <form onSubmit={onConnect} className="glass p-8 md:p-14 rounded-[3rem] md:rounded-[4rem] shadow-2xl space-y-8 md:space-y-12 relative overflow-hidden group">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between px-2">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em]">Repository Asset Location</label>
              <span className="text-[9px] font-mono text-amber-500/60 uppercase">Public Access Only</span>
            </div>
        ...
        <p className="text-center text-slate-600 text-[10px] uppercase font-bold tracking-widest px-8 leading-relaxed opacity-60">
          Powered by Gemini 3 Flash Intelligence & D3.js Logic Mapping
        </p>
      </div>
    </div>
  );
